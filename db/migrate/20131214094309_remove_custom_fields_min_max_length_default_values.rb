class RemoveCustomFieldsMinMaxLengthDefaultValues < ActiveRecord::Migration
  def up
    change_column :custom_fields, :min_length, :integer, :default => nil, :null => true
    change_column :custom_fields, :max_length, :integer, :default => nil, :null => true
  ...
  def self.down
    ...
    change_column :custom_fields, :min_length, :integer, :default => 0, :null => false
    change_column :custom_fields, :max_length, :integer, :default => 0, :null => false
  end
end
